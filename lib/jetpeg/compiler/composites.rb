  ...
  module Compiler
    ...
    class RuleCall < Primary
      ...
      def build(builder, start_input, modes, failed_block)
        ...
        call_rule_result = builder.call referenced.internal_match_function(builder.traced, false), start_input, builder.add_failure_callback, modes, *@arguments.map(&:value)
